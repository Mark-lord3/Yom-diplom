...
namespace DAL.Migrations
{
    ...
    [Migration("20231031020732_ChangePurchaseLogic")]
    partial class ChangePurchaseLogic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.UserReview", b =>
                {
                    b.HasOne("DAL.Entities.ApplicationUser", "UserReceiver")
                        .WithMany()
                        .HasForeignKey("UserReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Entities.ApplicationUser", "UserSender")
