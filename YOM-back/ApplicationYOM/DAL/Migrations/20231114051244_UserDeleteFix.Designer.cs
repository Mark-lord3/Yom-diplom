...
namespace DAL.Migrations
{
    ...
    [Migration("20231114051244_UserDeleteFix")]
    partial class UserDeleteFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Ad", b =>
                {
                    ...
                    b.Property<int?>("AdvertisementPlan")
                        .HasColumnType("int");

                    b.Property<decimal?>("AutoId")
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.Property<decimal>("PhoneClicks")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DAL.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("RefreshTokenExpiryInDays")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DAL.Entities.Auto", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DAL.Entities.Banner", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.Property<int>("BannerAdvertisementPlan")
                        .HasColumnType("int");

                    b.Property<int>("BannerPage")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ClicksCount")
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.Property<string>("LinkToCompany")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Entities.House", b =>
                {
                    ...
                    b.Property<string>("BuildingsType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Entities.LastViewedHistory", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DAL.Entities.UserConnectionInfo", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DAL.Entities.UserConversation", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DAL.Entities.Ad", b =>
                {
                    b.HasOne("DAL.Entities.Auto", "Auto")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.ApplicationUser", b =>
                {
                    b.HasOne("DAL.Entities.UserConnectionInfo", "UserInfo")
                        .WithOne()
                        .HasForeignKey("DAL.Entities.ApplicationUser", "UserInfoId");
            ...
            modelBuilder.Entity("DAL.Entities.Purchase", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.ApplicationUser", "Buyer")
                        .WithMany("PurchasesAsBuyer")
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("DAL.Entities.ApplicationUser", "Seller")
                        .WithMany("PurchasesAsSeller")
            ...
            modelBuilder.Entity("DAL.Entities.UserConversation", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.ApplicationUser", "Recipient")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.UserReview", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.ApplicationUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Entities.Ad", b =>
                {
                    ...
                    b.Navigation("LastViewedHistories");
            ...
            modelBuilder.Entity("DAL.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("PurchasesAsBuyer");

                    b.Navigation("PurchasesAsSeller");
